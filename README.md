...
- Open a Windows or Bash command-prompt and run the `nslookup` command passing byt the FQDN of the Azure Functions app as a parameter:
  ...
  ```sh
  nslookup myfuncapp.azurewebsites.net
  ```
  ...
  After this DNS configuration you can reach your Web App privately with the default name `myfuncapp.azurewebsites.net`. You must use this name, because the default certificate is issued for `*.azurewebsites.net`.
  ...
  | Name                                        | Type | Value      |
  |:--------------------------------------------|:-----|:-----------|
  | myfuncapp.privatelink.azurewebsites.net     |  A   | 10.0.1.11  |
  | myfuncapp.scm.privatelink.azurewebsites.net |  A   | 10.0.1.11  |
